...
/**
 * Plugin implementation of the 'donation_mode_formatter_type' formatter.
 *
 * @FieldFormatter(
 *   id = "donation_mode_formatter_type",
 ...
 * )
 */
class DonationModeFormatterType extends FormatterBase {
