 ...
 *
 * @see \Drupal\donation\Entity\DonationEntity.
 */
class DonationEntityAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\donation\Entity\DonationEntityInterface $entity */
